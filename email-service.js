        ...
        const response = await fetch("https://api.emailjs.com/api/v1.0/email/send", {
            ...
            body: JSON.stringify({
                ...
                template_params: {
                    ...
                    client_email: params.to_email,
                    recipient: params.to_email,
                    reply_to: DEFAULT_CONFIG.adminEmail,
                    client_name: params.client_name || "Valued Client",
                    name: params.client_name || "Valued Client",
                    to_name: params.client_name || "Valued Client",
                    booking_id: params.booking_id || "NB-APPOINTMENT",
                    order_id: params.booking_id || "NB-APPOINTMENT",
                    service: params.service || "Nail Service",
                    addons: params.addons || "None",
                    date: params.date || "--",
                    time: params.time || "--",
                    total_price: params.total_price || "R0.00",
                    price: params.total_price || "R0.00",
                    total: params.total_price || "R0.00",
                    status: params.status || "Pending Confirmation",
                    notes: params.notes || "None",
                    message: `Booking for ${params.service || 'Nail Service'} on ${params.date || ''} @ ${params.time || ''}. Total: ${params.total_price || 'R0.00'}. Ref: ${params.booking_id || ''}`,
                    studio_note: params.studio_note || "",
                    salon_name: DEFAULT_CONFIG.salonName,
